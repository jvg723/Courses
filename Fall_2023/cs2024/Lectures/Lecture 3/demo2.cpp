...
void  printMyName(short n) 
{
  for (int i=0; i<n; i++) 
  {
    std::cout << "Ron DiNapoli" << std::endl;
  }
}
...
{
  short i=5;
  // The following is how you'd initialize the variable with a hexadecimal number
  // You won't be responsible for knowing this and I'll explain in lecture
