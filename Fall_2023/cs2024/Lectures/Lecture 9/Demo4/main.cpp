...
class Point
	...
	public:
		...
		Point(Point anotherPoint);  // copy constructor (arg needs to be pass by reference or compilation will fail
		int getX() { return x; }
		int getY() { return y; }
...
// Here's the implementation of the copy constructor
// Must be pass-by-reference!  (Will get compiler error if
