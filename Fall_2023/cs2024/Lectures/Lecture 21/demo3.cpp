//
// CS2024 -- Lecture #21, Demo #3
//
// Avoiding Copies, part 3!
//
#include <iostream>
#include <map>
...
public:
  ...
  SomeClass(const SomeClass &copyFrom) {std::cout << "SomeClass COPY constructor: " << someMemberVar << std::endl; 
...
int main(int argc,char *argv[])
{
  ...
  // Then, print out contents of map
