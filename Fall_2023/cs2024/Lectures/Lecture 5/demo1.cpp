...
// CS 2024 -- Lecture #5
//
// Demo #1 -- Simple C Structure
//

#include <iostream>
// #include <string>  // Some compilers would have you add this, 
...
{	
	...
	// Assign initial values to the fields in the structure
	cs2024.name = "CS 2024";
	cs2024.instructor = "Ron DiNapoli";
	cs2024.numStudents = 120;
	
	// Echo back the values stored in the structure
