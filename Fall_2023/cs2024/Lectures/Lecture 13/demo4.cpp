...
int main(int argc, char *argv[]) 
{
  ...
  // What element number would you like to write "6" to?
  int index;
  cout << "Enter an element number to write the integer 6 to: ";
  cin >> index;

  // Warning!  This could crash if index is not "in bounds"
  someArray[index] = 6;
