...
int main(int argc,char *argv[])
{
  ...
  // use cin to input characters into buffer 1
  ...
  // Display buffer
  cout << "String read in was: " << buffer1 << endl;
  ...
  // And what happens if there's an emoji close to the last allowable character?
  cin.get(buffer2,SIZE);

  cout << "The string entered was: " << buffer2 << endl;

  // try again with the TAB space as the delimiter
  cout << "Enter another string (tab is delimeter): " << endl;
  cin.get(buffer2,SIZE,'\t');

  cout << "String entered was: " << buffer2 << endl;
