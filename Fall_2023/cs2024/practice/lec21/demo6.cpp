//
// CS2024 -- Lecture #21, Demo #6
//
// How to properly do a range-based for loop with a map 
// WITHOUT making unintentional copies
//
#include <iostream>
#include <map>
...
int main(int argc, char *argv[])
{
    ...
    for (const std::pair<const int,SomeClass> &q : myMap)
    {
