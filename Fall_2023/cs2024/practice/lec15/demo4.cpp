...
int main()
{
    ...
    for (vector<string>::iterator k = stringVector.begin(); k < stringVector.end(); ++k)
    {
    ...
    cout << endl << "Here comes the vector again after removing the 6th element" << endl;
    for (vector<string>::iterator k = stringVector.begin(); k < stringVector.end(); ++k)
    {
        cout << "Next Vector Element is: " << *k<< endl;
    }
