...
int main()
{
    ...
    IDRecord rec1(12345,"Joe Giliberto");
    IDRecord rec2(34564, "kristie LeBeau");
    ids.insert(rec1);
    ids.insert(rec2);
    ...
    // cout < "Next enry is: " << (*q).second << endl;
    ...
    // The size should be increase by 1!
    cout << "Size of map is: " << ids.size() << endl;

    // The size should be incresed by 1
    cout << "Size of map is: " << ids.size() << endl;
