...
/**
 * A square widget whose color depends on its row and column number and which shows when it has
 * been selected by a mouse click.
 */
public class CheckerSquare extends JPanel implements MouseListener {
    ...
    /** Whether this square is currently in the "selected" state. */
    boolean isSelected;
    ...
    /**
     * Fill square green if sum of row and column numbers are even, red if odd.
     * Fill pink circle if selected.
     * Draw a black border, and draw text with row and column coordinates.
     */
    @Override
    public void paint(Graphics g) {
        // By overriding `paint()` instead of `paintComponent()`, we lose the
        // ability to have Swing borders or children added to us, and we are
        // responsible for respecting opacity.
