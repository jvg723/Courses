% Solves incompressible Navier-Stokes equations for lid-driven cavity using
% finite volume discretization with staggered grid. Pressure-correction
% method (MAC) with Adams-Bashforth 2-step time integration, ADI and Thomas
% algorithm to solve the Poisson pressure equation.
